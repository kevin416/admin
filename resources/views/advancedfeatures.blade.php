...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/tags/dist/bootstrap-tagsinput.css') }}" />
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/vendors/switchery/switchery.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/vendors/switch/css/bootstrap3/bootstrap-switch.min.css') }}">
