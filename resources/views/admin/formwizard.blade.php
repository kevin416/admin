...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/select2/select2.min.css') }}" type="text/css" rel="stylesheet">
                            ...
                            <form id="wizard-validation" action="#">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="gender" class="form-control required" name="select">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/select2/select2.min.js') }}" type="text/javascript"></script>
